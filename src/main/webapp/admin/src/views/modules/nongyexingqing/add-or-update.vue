          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="农业行情" prop="nongyexingqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="农业行情"
                  v-model="ruleForm.nongyexingqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.nongyexingqing" label="农业行情" prop="nongyexingqing">
                    <span>{{ruleForm.nongyexingqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='nongyexingqing'){
            this.ruleForm.nongyexingqing = obj[o];
	    this.ro.nongyexingqing = true;
            continue;
          }
	            	            if(o=='faburiqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `nongyexingqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.nongyexingqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
