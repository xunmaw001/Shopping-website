          ...
          <el-form-item class="input" v-if="ruleForm.zongjiage" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="购买部日期" prop="goumaiburiqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.goumaiburiqi" 
                type="date"
                placeholder="购买部日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goumaiburiqi" label="购买部日期" prop="goumaiburiqi">
              <el-input v-model="ruleForm.goumaiburiqi" 
                placeholder="购买部日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
            continue;
	            	            ...
	            	            if(o=='goumaiburiqi'){
            this.ruleForm.goumaiburiqi = obj[o];
	    this.ro.goumaiburiqi = true;
            continue;
          }
	            	            if(o=='yonghuming'){
